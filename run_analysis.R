...
# Verify that there is or is not a ./data directory
...
# Removing the pound sign activates and prints out the data to the console
...
# Develops an object by merging the training and the test sets to create one data set
# Each new dataset is developed by using two files differeentiated as to "train" and "test"
# The new table is made by binding the rows for both files to create a new object
# for subject, activity, features
...
# A new data frame, datacombine, is developed by binding 
# all columns from the three distinct previous filese columns to get the data frame Data for all data

dataCombine <- cbind(dataSubject, dataActivity)
Data <- cbind(dataFeatures, dataCombine)


# This makes a new object by selecting out those observation marked by the terms
# "mean" amd "std" to make a new .  This subset Name of Features by measurements 
...
# This uses descriptive activity names from the file activity_labels.txt 
